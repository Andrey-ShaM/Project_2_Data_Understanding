...
4. Определили распределение количества вакансий по сочетанию типа рабочего графика (schedule) и типа трудоустройства (employment), по требуемому опыту работы, по работадателю и региону.
6. Определели распределение работадателей по регионам.
...
9. Из всех представленных вакансий только 1771 имеет отношение к данным. 
